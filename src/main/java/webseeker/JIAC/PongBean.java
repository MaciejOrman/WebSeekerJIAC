...
public class PongBean extends AbstractAgentBean {
	...
	public void doStart() throws Exception {
		super.doStart();
		log.info("PongAgent - starting....");
		log.info("PongAgent - my ID: " + this.thisAgent.getAgentId());
		log.info("PongAgent - my Name: " + this.thisAgent.getAgentName());
		log.info("PongAgent - my Node: " + this.thisAgent.getAgentNode().getName());
